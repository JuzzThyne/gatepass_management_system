<?php
    ...
    header('location:logout.php');
        ...
        if ($query) {
            $msg="Residents Remark has been Updated.";
        }else{
            $msg="Something Went Wrong. Please try again";
            }
            $query1=mysqli_query($con,"UPDATE apartment set stat='0' where homeowner='$hname'");  
            if($query1)
            {
              $msg="Residents outtime has been Updated.";
            }
    }
?>
<!DOCTYPE html>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Residential's Full Name</label>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Residential's  Entry Date and Time</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Residential's Contact Number</label>
                ...
                <button type="submit" class="btn btn-block btn-danger btn-lg" name="submit">Check Out Residents</button>
                </div>
                <?php } else { ?>
