<header class="main-header">
    ...
    <a href="dashboard.php" class="logo">
      ...
      <span class="logo-lg"><b>Private Subdivision</b> Gatepass Management System</span>
    </a>
        ...
        $name=$row['AdminName']; ?>  
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/img-admin.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                <?php echo $name; ?> - Handy Hunt
                  <small>A group of UCC Students</small>
                </p>
