    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="dist/img/img-admin.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($page=='apartment') { echo 'active'; }?>">
          <a href="manage-apartment.php">
            <i class="fa fa-building-o"></i> <span>Manage House and Lot</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        <li class="<?php if($page=='qrscanner') { echo 'active'; }?>">
          <a href="qrcode.php">
            <i class="fa fa-building-o"></i> <span>QR CODE SCANNER</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
        <li class="<?php if($page=='visitors') { echo 'active'; }?>">
          <a href="visitor-entry-vis.php">
            <i class="fa fa-plus-square"></i> <span>Entry Visitors</span>        
          </a>
        </li>

        <li class="<?php if($page=='checkout_visitors') { echo 'active'; }?>">
          <a href="checkout_visitor.php">
            <i class="fa fa-sign-out"></i> <span>Check-Out Residents</span>
            <span class="pull-right-container">
        ...
        <li class="<?php if($page=='visitor-management') { echo 'active'; }?>">
          <a href="visitor-mgmt.php">
            <i class="fa fa-address-card"></i> <span>Residentials Management</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
